...
const BLOG = {
  ...
  // ACKEE网站访客统计工具
  ANALYTICS_ACKEE_TRACKER: process.env.NEXT_PUBLIC_ANALYTICS_ACKEE_TRACKER || 'https://track-quecheny.netlify.app/tracker.js', // e.g 'https://ackee.tangly1024.com/tracker.js'
  ANALYTICS_ACKEE_DATA_SERVER: process.env.NEXT_PUBLIC_ANALYTICS_ACKEE_DATA_SERVER || 'https://track-quecheny.netlify.app', // e.g https://ackee.tangly1024.com , don't end with a slash
